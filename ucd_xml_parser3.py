...
#		f.write(minidom.parseString(etree.tostring(root)).toprettyxml)
# TypeError: write() argument must be str, not method
# https://stackoverflow.com/questions/3204614/how-to-change-any-data-type-into-a-string
#		f.write(minidom.parseString(etree.tostring(root)))
